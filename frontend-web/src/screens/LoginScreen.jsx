...
const USUARIOS = [
  { correo: 'admin@ecobazar.com',    contrasena: '123456', rol: 'admin',    nombre: 'Admin' },
  { correo: 'vendedor@ecobazar.com', contrasena: '123456', rol: 'vendedor', nombre: 'Vendedor' },
  { correo: 'cliente@ecobazar.com',  contrasena: '123456', rol: 'cliente',  nombre: 'Usuario google' },
]
  ...
  return (
    <div>
      ...
      <div className="login-body">
        ...
        <button className="btn-login-principal" onClick={handleLogin}>
          Iniciar sesión
        </button>
