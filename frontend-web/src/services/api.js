...
const PUBLIC_ERROR_MESSAGES = {
  ...
  EMAIL_TOKEN_INVALID: 'El enlace de verificación no es válido o ya venció.',
  PASSWORD_RESET_TOKEN_INVALID: 'El enlace para cambiar la contraseña no es válido o ya venció.',
  GOOGLE_EMAIL_NOT_VERIFIED: 'Tu cuenta de Google debe tener el correo verificado.',
  CSRF_ORIGIN_REJECTED: 'No se pudo validar el origen de la solicitud.',
